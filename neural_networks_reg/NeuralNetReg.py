...
with tf.Session() as sess:
    ...
    #         if i == (int(raw_data.shape[0] / batch_size) + 1):
    #             batch_X = train_X[int(raw_data.shape[0] / batch_size):]
    #             batch_y = train_y[int(raw_data.shape[0] / batch_size):]
    #
    ...
    for i in range(int(raw_data.shape[0] / batch_size) + 1):
        ...
        # If the batch size is too big for the last bit of data
        if i == (int(raw_data.shape[0] / batch_size) + 1):
            batch_X = overall_X[int(raw_data.shape[0] / batch_size):]
            batch_y = overall_y[int(raw_data.shape[0] / batch_size):]
